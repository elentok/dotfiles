...
function main() {
  return __awaiter(this, void 0, void 0, function* () {
    ...
    program.command("remove-complete").action(() =>
      __awaiter(this, void 0, void 0, function* () {
    ...
    program.command("add-magnet <link>").action((link) =>
      __awaiter(this, void 0, void 0, function* () {
...
function getClient() {
  return __awaiter(this, void 0, void 0, function* () {
    if (client == null) {
      ...
      const port = Number(
        yield (0, dotconfig_1.getConfigOrAsk)("transmission_port", "Transmission port? ")
      )
      const username = yield (0, dotconfig_1.getConfigOrAsk)(
        "transmission_username",
        "Transmission username? "
      )
      const password = yield (0, dotconfig_1.getConfigOrAsk)(
