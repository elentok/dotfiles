...
// with minor modifications to colors and duration
...
const vec4 TRAIL_COLOR = vec4(0.8, 0.8, 0.8, 1.0); // yellow
const vec4 CURRENT_CURSOR_COLOR = TRAIL_COLOR;
const vec4 PREVIOUS_CURSOR_COLOR = TRAIL_COLOR;
const vec4 TRAIL_COLOR_ACCENT = vec4(0., 0., 0., 1.0); // red-orange
