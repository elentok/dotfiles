...
- **Local tracker.** Use the [local-markdown tracker](../setup-elentok-skills/issue-tracker-local.md)
  regardless of what this repo's issue tracker would otherwise resolve to.
